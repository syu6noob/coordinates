...
public final class Coordinates extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        this.getCommand("coords").setTabCompleter(new CoordinatesTabCompleter());
    ...
    private void sendActionBar(Player player, String coords, String time) {
        Component message = mm.deserialize("" + coords + " <grey>|</grey> <yellow>Time:</yellow> <white>" + time + "</white>");
